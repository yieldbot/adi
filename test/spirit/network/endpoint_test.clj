(ns spirit.network.endpoint-test
  (:use hara.test)
  (:require [spirit.network.endpoint :refer :all]
            [spirit.network.common :as common]
            [hara.component :as component]
            [clojure.core.async :as async]))

^{:refer spirit.network.endpoint/send-fn :added "0.5"}
...
^{:refer spirit.network.endpoint/attach-fn :added "0.5"}
...
^{:refer spirit.network.endpoint/close-fn :added "0.5"}
...
^{:refer spirit.network.endpoint/active?-fn :added "0.5"}
...
^{:refer spirit.network.endpoint/endpoint :added "0.5"}
...
^{:refer spirit.network.endpoint/connect :added "0.5"}
...
^{:refer spirit.network.endpoint/coupled :added "0.5"}
