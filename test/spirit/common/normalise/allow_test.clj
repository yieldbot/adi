(ns spirit.common.normalise.allow-test
  (:use hara.test)
  (:require [data.examples :as examples]
            [spirit.common.schema :as schema]
            [spirit.common.normalise :as normalise]
            [spirit.common.normalise.allow :as allow]))

(def ^:dynamic *wrappers*
  {:normalise        [normalise/wrap-plus]
   :normalise-branch [allow/wrap-branch-model-allow normalise/wrap-key-path]
   :normalise-attr   [allow/wrap-attr-model-allow normalise/wrap-key-path]})

^{:refer spirit.common.normalise.allow/wrap-branch-model-allow :added "0.3"}
...
^{:refer spirit.common.normalise.allow/wrap-branch-model-allow-refs :added "0.3"}
