(ns spirit.common.normalise.require-test
  (:use hara.test)
  (:require [data.examples :as examples]
            [spirit.common.schema :as schema]
            [spirit.common.normalise :as normalise]
            [spirit.common.normalise.require :as require]))

(def ^:dynamic *wrappers*
  {:normalise        [normalise/wrap-plus require/wrap-model-pre-require]
   :normalise-branch [normalise/wrap-key-path]
   :normalise-attr   [normalise/wrap-key-path]})

^{:refer spirit.common.normalise.require/process-require :added "0.3"}
...
^{:refer spirit.common.normalise.require/wrap-model-pre-require :added "0.3"}
