(ns spirit.core.rabbitmq.api-test
  (:use hara.test)
  (:require [spirit.core.rabbitmq.api :refer :all]))

^{:refer spirit.core.rabbitmq.api/classify-args :added "0.5"}
...
^{:refer spirit.core.rabbitmq.api/build-args :added "0.5"}
...
^{:refer spirit.core.rabbitmq.api/links-args :added "0.5"}
...
^{:refer spirit.core.rabbitmq.api/create-link-form :added "0.5"}
(fact "creates link form from vargs"
  ...
  (create-link-form '{:inputs ["hello" (:world rabbitmq) foo bar]
                    ...
                    :delete)
  => '([rabbitmq foo bar]
       (spirit.core.rabbitmq.request/request
        rabbitmq
        (clojure.string/join "/"
                             ["hello"
                              (:world rabbitmq)
...
^{:refer spirit.core.rabbitmq.api/create-body-form :added "0.5"}
...
^{:refer spirit.core.rabbitmq.api/create-accessor-form :added "0.5"}
...
^{:refer spirit.core.rabbitmq.api/create-function-form :added "0.5"}
...
^{:refer spirit.core.rabbitmq.api/create-api-functions :added "0.5"}
