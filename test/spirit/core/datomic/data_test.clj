(ns spirit.core.datomic.data-test
  (:use hara.test)
  (:require [spirit.core.datomic.data :refer :all]))

^{:refer spirit.core.datomic.data/iid :added "0.3"}
...
^{:refer spirit.core.datomic.data/isym :added "0.3"}
...
^{:refer spirit.core.datomic.data/vexpr->expr :added "0.3"}
