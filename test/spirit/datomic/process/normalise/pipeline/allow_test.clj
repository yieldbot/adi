(ns spirit.datomic.process.normalise.pipeline.allow-test
  (:use hara.test)
  (:require [data.examples :as examples]
            ...
            [spirit.datomic.process.normalise.pipeline.allow :as allow]))
...
^{:refer spirit.datomic.process.normalise.pipeline.allow/wrap-branch-model-allow :added "0.3"}
...
^{:refer spirit.datomic.process.normalise.pipeline.allow/wrap-branch-model-allow-refs :added "0.3"}
