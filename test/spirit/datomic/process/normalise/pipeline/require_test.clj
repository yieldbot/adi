(ns spirit.datomic.process.normalise.pipeline.require-test
  (:use hara.test)
  (:require [data.examples :as examples]
            ...
            [spirit.datomic.process.normalise.pipeline.require :as require]))
...
^{:refer spirit.datomic.process.normalise.pipeline.require/process-require :added "0.3"}
...
^{:refer spirit.datomic.process.normalise.pipeline.require/wrap-model-pre-require :added "0.3"}
