(ns spirit.datomic.process.normalise.pipeline.mask-test
  (:use hara.test)
  (:require [data.examples :as examples]
            ...
            [spirit.datomic.process.normalise.pipeline.mask :as mask]))
...
^{:refer spirit.datomic.process.normalise.pipeline.mask/process-mask :added "0.3"}
...
^{:refer spirit.datomic.process.normalise.pipeline.mask/wrap-model-pre-mask :added "0.3"}
