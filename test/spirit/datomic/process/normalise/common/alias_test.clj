(ns spirit.datomic.process.normalise.common.alias-test
  (:use hara.test)
  (:require [spirit.datomic.process.normalise.base :as normalise]
            [spirit.datomic.process.normalise.common.alias :refer :all]
            [spirit.datomic.process.normalise.common.db :as db]
            [spirit.datomic.process.normalise.common.set :as set]
...
^{:refer spirit.datomic.process.normalise.common.alias/wrap-alias :added "0.3"}
