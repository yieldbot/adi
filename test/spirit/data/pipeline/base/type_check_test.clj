(ns spirit.data.pipeline.base.type-check-test
  (:use hara.test)
  (:require [spirit.data.pipeline :as pipeline]
            [spirit.data.pipeline.base.type-check :refer :all]
            [spirit.data.schema :as schema]
            [data.examples :as examples]))

^{:refer spirit.data.pipeline.base.type-check/wrap-single-type-check :added "0.3"}
