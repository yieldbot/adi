...
^{:refer spirit.data.pipeline.allow/wrap-branch-model-allow :added "0.3"}
...
^{:refer spirit.data.pipeline.allow/wrap-branch-model-allow-refs :added "0.3"}
