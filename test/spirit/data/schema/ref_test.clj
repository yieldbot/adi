(ns spirit.data.schema.ref-test
  (:use hara.test)
  (:require [spirit.data.schema.ref :refer :all]))

^{:refer spirit.data.schema.ref/is-reversible? :added "0.3"}
...
^{:refer spirit.data.schema.ref/determine-rval :added "0.3"}
...
^{:refer spirit.data.schema.ref/forward-ref-attr :added "0.3"}
...
^{:refer spirit.data.schema.ref/reverse-ref-attr :added "0.3"}
...
^{:refer spirit.data.schema.ref/attr-ns-pair :added "0.3"}
...
^{:refer spirit.data.schema.ref/mark-multiple :added "0.3"}
...
^{:refer spirit.data.schema.ref/ref-attrs :added "0.3"}
