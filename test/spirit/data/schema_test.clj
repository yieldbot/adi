(ns spirit.data.schema-test
  (:use hara.test)
  (:require [spirit.data.schema :refer :all]))

^{:refer spirit.data.schema/simplify :added "0.3"}
...
^{:refer spirit.data.schema/create-lookup :added "0.3"}
...
^{:refer spirit.data.schema/create-flat-schema :added "0.3"}
...
^{:refer spirit.data.schema/schema :added "0.3"}
