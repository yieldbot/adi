(ns spirit.data.pipeline-test
  (:use hara.test)
  (:require [spirit.data.pipeline :refer :all]
            [spirit.data.schema :as schema]
            [data.examples :as examples]))

^{:refer spirit.data.pipeline/submaps :added "0.3"}
...
^{:refer spirit.data.pipeline/normalise :added "0.3"}
...
^{:refer spirit.data.pipeline/wrap-plus :added "0.3"}
...
^{:refer spirit.data.pipeline/wrap-ref-path :added "0.3"}
...
^{:refer spirit.data.pipeline/wrap-key-path :added "0.3"}
