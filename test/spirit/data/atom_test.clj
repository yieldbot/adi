(ns spirit.data.atom-test
  (:use hara.test)
  (:require [spirit.data.atom :refer :all]
            [hara.io.file :as fs]))

^{:refer spirit.data.atom/write-value :added "0.5"}
...
^{:refer spirit.data.atom/read-value :added "0.5"}
...
^{:refer spirit.data.atom/file-out :added "0.5"}
...
^{:refer spirit.data.atom/log-out :added "0.5"}
...
^{:refer spirit.data.atom/derived :added "0.5"}
