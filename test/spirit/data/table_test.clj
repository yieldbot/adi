(ns spirit.data.table-test
  (:use hara.test)
  (:require [spirit.data.table :refer :all]
...
^{:refer spirit.data.table/generate-basic-table :added "0.5"}
...
^{:refer spirit.data.table/parse-basic-table :added "0.5"}
...
^{:refer spirit.data.table/generate-single-table :added "0.5"}
...
^{:refer spirit.data.table/parse-single-table :added "0.5"}
(fact "generates a single table"
...
^{:refer spirit.data.table/write-table :added "0.5"}
(fact "generates a single table"
...
^{:refer spirit.data.table/read-table :added "0.5"}
(fact "generates a single table"
