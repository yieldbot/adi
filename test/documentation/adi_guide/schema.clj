(ns documentation.adi-guide.schema
  (:use midje.sweet)
...
"`adi` offers sane defaults and attempts to remove noise as much as possible. Therefore, the datomic schema:"
...
(comment
  (adi/schema {:account {:book [{:type :ref
                                 :ref {:ns :book}}]}
               :book {:name [{}]}})
...
(comment
  (adi/schema {:account {:like [{:type :ref
                                 :ref {:ns :book}}]
                         :dislike [{:type :ref
                                 :ref {:ns :book}}]}
               :book {:name [{}]}})
...
"Specifies a boolean value indicating that that when data is inserted, that the entry exists. Does not matter for update and query. See [walkthrough](./adi-walkthrough.html#step-one) for example."

[[:section {:title ":restrict"}]]

"Specifies a vector, the first being a readable message, the second being the predicate. Like `:required`, only works for data insertion. See [walkthrough](./adi-walkthrough.html#step-one) for example."

[[:section {:title ":default"}]]

"Specifies a value that will be inserted if nothing is specified. See [walkthrough](./adi-walkthrough.html#step-one) for example."
