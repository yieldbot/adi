(ns documentation.spirit-walkthrough)
...
[spirit](https://www.github.com/zcaudate/spirit) has been designed to generalize the mechanisms for allowing data from an insecure web interface directly into the database. It consists of a declarative security model, a compact object-based syntax that is built on top of datomic.
"

[[:section {:title "Off and Running"}]]

"Open up a repl in a project with `spirit` installed and require load up the library:"


[[:file {:src "test/documentation/spirit_walkthrough/step_1.clj"}]]
[[:file {:src "test/documentation/spirit_walkthrough/step_2.clj"}]]
[[:file {:src "test/documentation/spirit_walkthrough/step_3.clj"}]]
[[:file {:src "test/documentation/spirit_walkthrough/bookstore.clj"}]]
[[:file {:src "test/documentation/spirit_walkthrough/schoolyard.clj"}]]
