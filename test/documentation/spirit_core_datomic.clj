(ns documentation.spirit-core-datomic
  (:use hara.test)
...
"
All functionality is contained in the `spirit.core.datomic` namespace:
"
...
"[spirit.core.datomic](https://www.github.com/zcaudate/spirit) provides the following advantages
