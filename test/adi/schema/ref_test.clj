(ns adi.schema.ref-test
  (:use midje.sweet)
  (:require [adi.schema.ref :refer :all]))

^{:refer adi.schema.ref/keyword-reverse :added "0.3"}
...
^{:refer adi.schema.ref/keyword-reversed? :added "0.3"}
...
^{:refer adi.schema.ref/is-reversible? :added "0.3"}
...
^{:refer adi.schema.ref/determine-rval :added "0.3"}
...
^{:refer adi.schema.ref/forward-ref-attr :added "0.3"}
...
^{:refer adi.schema.ref/reverse-ref-attr :added "0.3"}
...
^{:refer adi.schema.ref/attr-ns-pair :added "0.3"}
...
^{:refer adi.schema.ref/mark-multiple :added "0.3"}
...
^{:refer adi.schema.ref/ref-attrs :added "0.3"}
