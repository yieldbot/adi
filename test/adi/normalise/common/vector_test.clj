...
^{:refer adi.normalise.common.vector/is-vecxpr :added "0.3"}
(fact "checks whether an input is a vector expression"
  (is-vecxpr [[":hello"]]) => true)

^{:refer adi.normalise.common.vector/vecxpr->xpr :added "0.3"}
(fact "checks whether an input is a vector expression"
  (vecxpr->xpr [["_"]]) => '_
...
^{:refer adi.normalise.common.vector/wrap-attr-vector :added "0.3"}
