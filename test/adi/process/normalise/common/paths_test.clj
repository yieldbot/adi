(ns adi.process.normalise.common.paths-test
  (:use midje.sweet)
  (:require [adi.process.normalise.base :as normalise]
            [adi.process.normalise.common.paths :refer :all]
            [adi.schema :as schema]
            [adi.test.examples :as examples]
            [adi.test.checkers :refer [raises-issue]]))

^{:refer adi.process.normalise.common.paths/wrap-plus :added "0.3"}
...
^{:refer adi.process.normalise.common.paths/wrap-ref-path :added "0.3"}
...
^{:refer adi.process.normalise.common.paths/wrap-key-path :added "0.3"}
