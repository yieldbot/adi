(ns spirit.transport-test
  (:use hara.test)
  (:require [spirit.transport :refer :all]
            [hara.component :as component]
            [org.httpkit.client :as http]))

^{:refer spirit.transport/default-event-handler :added "0.5"}
(fact "default handler for events from client")

^{:refer spirit.transport/default-request-handler :added "0.5"}
(fact "default handler for requests from client")

^{:refer spirit.transport/wrap-scope :added "0.5"}
(fact "adds a scope key to the request")

^{:refer spirit.transport/adjust-path :added "0.5"}
(fact "adds separators to the input path"

  (adjust-path "api")
  => "/api/")

^{:refer spirit.transport/create-websocket-routes :added "0.5"}
(fact "specified using the 'path' input")

^{:refer spirit.transport/create-websocket-handler :added "0.5"}
...
^{:refer spirit.transport/create-websocket :added "0.5"}
...
^{:refer spirit.transport/create-application-handler :added "0.5"}
...
^{:refer spirit.transport/create-application :added "0.5"}
...
^{:refer spirit.transport/create-routes :added "0.5"}
(fact "adds both websocket and application routes")

^{:refer spirit.transport/wrap-app :added "0.5"}
(fact "adds defaults to app")

^{:refer spirit.transport/application :added "0.5"}
