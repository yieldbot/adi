(ns spirit.core.retract
  (:require [hara.common.checks :refer [hash-map?]]
            [hara.string.path :as path]
            [spirit.data.checks :refer [entity?]]
            [spirit.core
             [select :as select]
             [prepare :as prepare]
...
(defn- make-entry-recs [ets entry spirit]
