(ns spirit.core.link
  (:require [hara.common [checks :refer [hash-map?]]]
            [spirit.core.prepare :as prepare]
...
(defn linked-entities [ent rmodel spirit]
  (let [spirit (prepare/prepare spirit {})]
    (map #(datomic/entity (:db spirit) %) (linked-ids ent rmodel (-> spirit :schema :flat)))))
