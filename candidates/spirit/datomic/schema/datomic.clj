...
(defn datomic-attr-property
  "creates a property description from an spirit one
...
(defn datomic-attr
  "creates a field description from a single spirit attribute
...
(defn datomic-enum
  "creates schema idents from the spirit enum attr
...
(defn datomic
  "creates a datomic-compatible schema from an spirit one
