(ns adi.process.normalise.common.underscore-test
  (:use midje.sweet)
  (:require [adi.process.normalise.base :as normalise]
            [adi.process.normalise.common.underscore :refer :all]
            [adi.schema :as schema]
            [adi.test.examples :as examples]
            [adi.test.checkers :refer [raises-issue]]))

^{:refer adi.process.normalise.common.underscore/rep-key :added "0.3"}
...
^{:refer adi.process.normalise.common.underscore/wrap-branch-underscore :added "0.3"}
