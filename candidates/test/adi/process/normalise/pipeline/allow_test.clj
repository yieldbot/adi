(ns adi.process.normalise.pipeline.allow-test
  (:use midje.sweet)
  (:require [adi.test.examples :as examples]
            ...
            [adi.process.normalise.pipeline.allow :as allow]))
...
^{:refer adi.process.normalise.pipeline.allow/wrap-branch-model-allow :added "0.3"}
...
^{:refer adi.process.normalise.pipeline.allow/wrap-branch-model-allow-refs :added "0.3"}
