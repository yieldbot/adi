(ns spirit.data.common-test
  (:use hara.test)
  (:require [spirit.data.common :refer :all]))

^{:refer spirit.data.common/iid :added "0.3"}
...
^{:refer spirit.data.common/isym :added "0.3"}
...
^{:refer spirit.data.common/vexpr->expr :added "0.3"}
