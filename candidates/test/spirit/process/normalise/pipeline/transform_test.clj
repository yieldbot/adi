(ns spirit.process.normalise.pipeline.transform-test
  (:use hara.test)
  (:require [spirit.test.examples :as examples]
            ...
            [spirit.process.normalise.pipeline.transform :as transform]))
...
^{:refer spirit.process.normalise.pipeline.transform/process-transform :added "0.3"}
...
^{:refer spirit.process.normalise.pipeline.transform/wrap-model-pre-transform :added "0.3"}
