(ns spirit.process.normalise.pipeline.allow-test
  (:use hara.test)
  (:require [spirit.test.examples :as examples]
            ...
            [spirit.process.normalise.pipeline.allow :as allow]))
...
^{:refer spirit.process.normalise.pipeline.allow/wrap-branch-model-allow :added "0.3"}
...
^{:refer spirit.process.normalise.pipeline.allow/wrap-branch-model-allow-refs :added "0.3"}
