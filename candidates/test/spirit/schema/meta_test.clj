(ns spirit.schema.meta-test
  (:use hara.test)
  (:require [spirit.schema.meta :as meta]))

^{:refer spirit.schema.meta/schema-property :added "0.3"}
...
^{:refer spirit.schema.meta/attr-add-ident :added "0.3"}
...
^{:refer spirit.schema.meta/attr-add-defaults :added "0.3"}
