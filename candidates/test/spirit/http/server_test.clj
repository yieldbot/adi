(ns spirit.transport.server-test
  (:use hara.test)
  (:require [spirit.transport.server :refer :all]
            [spirit.transport.net :as transport]
            [hara.event :as event]))

^{:refer spirit.transport.server/create :added "0.5"}
(fact "multimethod entrypoint for server construction")

^{:refer spirit.transport.server/trim-seperators :added "0.5"}
(fact "gets rid of seperators on ends of string"

  (trim-seperators "//api/me//")
  => "api/me")

^{:refer spirit.transport.server/wrap-trim-uri :added "0.5"}
...
^{:refer spirit.transport.server/wrap-path-uri :added "0.5"}
...
^{:refer spirit.transport.server/wrap-routes :added "0.5"}
(fact "gets rid of hanging seperator in :uri field"
...
^{:refer spirit.transport.server/wrap-parse-data :added "0.5"}
...
^{:refer spirit.transport.server/wrap-response :added "0.5"}
(fact "reads data from `:body` and store in `:data`"
...
^{:refer spirit.transport.server/wrap-transport :added "0.5"}
...
^{:refer spirit.transport.server/base-handler :added "0.5"}
...
^{:refer spirit.transport.server/wrappers :added "0.5"}
(comment "accesses default wrappers in the `common.server` namespace")

^{:refer spirit.transport.server/wrap-handler :added "0.5"}
...
^{:refer spirit.transport.server/create-application-handler :added "0.5"}
...
^{:refer spirit.transport.server/create-handler :added "0.5"}
